...
import br.com.mv.spring_boot_essentials.database.model.TreinosEntity;
...
import br.com.mv.spring_boot_essentials.database.repository.ITreinosRepository;
import br.com.mv.spring_boot_essentials.dto.TreinoDto;
    ...
    public void criarTreino(TreinoDto treinoDto) throws NotFoundException, BadRequestException {
        ...
        for (Integer exercicioId : treinoDto.getExerciciosIds()){
            ExerciciosEntity exercicio = exerciciosRepository.findById(exercicioId)
                    .orElseThrow(() -> new NotFoundException("Exercício %s não encontrado"));
